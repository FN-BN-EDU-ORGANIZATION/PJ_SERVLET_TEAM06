...
import User.user_delete;
import User.user_insert;
import User.user_select;
import User.user_select_all;
import User.user_update;
import User.Auth.LoginController;
...
public class FrontController extends HttpServlet {
    ...
    public void init(ServletConfig config) throws ServletException {
        ...
        // user
        map.put(projectPath + "/user/insert.do", new user_insert());
